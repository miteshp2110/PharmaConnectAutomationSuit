...
public class RegisterTest extends BaseTest {
    ...
    public void validateEmptyFields(){
        getWebDriver().get(ConfigReader.getProperty("register.url"));
        RegisterPage registerPage = getPageObjectManager().getRegisterPage();
    ...
    public void validateTermsAndConditions(){
        ...
        registerPage.clickCreateAccount();
        Assert.assertTrue(Objects.requireNonNull(getWebDriver().getCurrentUrl()).contains(ConfigReader.getProperty("register.url")),"Without accepting terms and condition the user was created");
    ...
    public void validateSigInLink(){
        ...
        Assert.assertTrue(Objects.requireNonNull(getWebDriver().getCurrentUrl()).contains(ConfigReader.getProperty("login.url")),"The user was not redirected to the login page");
    }
